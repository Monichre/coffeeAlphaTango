...
define("client/templates/components/plaid-call", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template((function () {
    return {
      ...
      statements: [["element", "action", ["callApi", ["get", "users", ["loc", [null, [1, 27], [1, 32]]]]], [], ["loc", [null, [1, 8], [1, 34]]]]],
      locals: [],
      templates: []
    };
  })());
...
define("client/templates/index", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template((function () {
    return {
      ...
      statements: [["inline", "plaid-call", [], ["users", ["subexpr", "@mut", [["get", "model", ["loc", [null, [4, 21], [4, 26]]]]], [], []]], ["loc", [null, [4, 2], [4, 28]]]]],
      locals: [],
      templates: []
    };
  })());
...
if (!runningTests) {
  require("client/app")["default"].create({"name":"client","version":"0.0.0+8600c847"});
}
